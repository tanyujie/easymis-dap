...
import org.easymis.dap.catalog.util.MD5Util;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	MyUserDetialsService userService;
	 @Override
	    public void configure(WebSecurity web) throws Exception {
	        //解决静态资源被拦截的问题
	        web.ignoring().antMatchers("/resources/**","/static/**","/favicon.ico","/css/**","/common/**","/js/**","/plugins/**","/scss/**","/images/**",
	        		  "/captcha.jpg");
	    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
          ...
          .antMatchers( "/resources/**","/static/**","/favicon.ico","/css/**","/common/**","/js/**","/plugins/**","/scss/**","/images/**",
        		  "/captcha.jpg","/login","/login.html","/login.do","/userLogin","/login-error",
        		  "/static/plugins/datatables/cn.json",
        		  "/scss/icons/font-awesome/fonts/fontawesome-webfont.ttf").permitAll()
